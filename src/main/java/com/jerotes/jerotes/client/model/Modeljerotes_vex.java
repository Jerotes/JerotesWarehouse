...
@OnlyIn(Dist.CLIENT)
public class Modeljerotes_vex extends HierarchicalModel<JerotesVexEntity> implements ArmedModel {
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation(JerotesWarehouse.MODID, "jerotes_vex"), "main");
	...
	public Modeljerotes_vex(ModelPart p_171045_) {
	...
	public void setupAnim(JerotesVexEntity p_104028_, float p_104029_, float p_104030_, float p_104031_, float p_104032_, float p_104033_) {
