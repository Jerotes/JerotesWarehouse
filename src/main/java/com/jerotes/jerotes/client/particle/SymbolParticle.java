...
public class SymbolParticle extends TextureSheetParticle {
	...
	public static class DisplayParticleProvider implements ParticleProvider<SimpleParticleType> {
		...
		public Particle createParticle(SimpleParticleType typeIn, ClientLevel worldIn, double x, double y, double z,
			...
			return new SymbolParticle(worldIn, x, y, z, xSpeed, ySpeed, zSpeed, this.spriteSet);
		}
	}

	private final SpriteSet spriteSet;
	private float initialScale = 0f;
	private float peakScale = 0.2f;
	private int fadeInTime = 5;   // 淡入帧数
	private int fadeOutTime = 5;  // 淡出帧数

	protected SymbolParticle(ClientLevel world, double x, double y, double z,
