...
public class JerotesEvokerFangRenderer extends EntityRenderer<JerotesEvokerFangEntity> {
    private static final ResourceLocation TEXTURE_LOCATION = new ResourceLocation("textures/entity/illager/evoker_fangs.png");
    private final EvokerFangsModel<JerotesEvokerFangEntity> model;

    public JerotesEvokerFangRenderer(EntityRendererProvider.Context p_174100_) {
        super(p_174100_);
        this.model = new EvokerFangsModel<>(p_174100_.bakeLayer(ModelLayers.EVOKER_FANGS));
    }

    public void render(JerotesEvokerFangEntity p_114528_, float p_114529_, float p_114530_, PoseStack p_114531_, MultiBufferSource p_114532_, int p_114533_) {
    ...
    public ResourceLocation getTextureLocation(JerotesEvokerFangEntity p_114526_) {
