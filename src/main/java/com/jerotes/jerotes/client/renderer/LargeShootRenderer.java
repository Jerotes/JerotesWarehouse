...
public class LargeShootRenderer<T extends Projectile> extends EntityRenderer<T> {
    ...
    public LargeShootRenderer(EntityRendererProvider.Context context, float f, boolean bl) {
        super(context);
    ...
    public LargeShootRenderer(EntityRendererProvider.Context context) {
