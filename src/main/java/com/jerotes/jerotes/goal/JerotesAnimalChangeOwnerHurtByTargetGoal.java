...
public class JerotesAnimalChangeOwnerHurtByTargetGoal extends JerotesAnimalOwnerHurtByTargetGoal {
    private final ChangePoseAbout tameMob;

    public JerotesAnimalChangeOwnerHurtByTargetGoal(ChangePoseAbout tameMob) {
