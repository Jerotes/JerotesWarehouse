...
public class JerotesCombatIIIMagicAttackGoal<T extends PathfinderMob> extends Goal {
    private final T mob;
    ...
    public JerotesCombatIIIMagicAttackGoal(T t, double d, float f, float f2) {
        this.mob = t;
    ...
    public boolean canUse() {
        if (!(this.mob instanceof WizardEntity wizardEntity && wizardEntity.getCombatStyle() == 3)) {
            return false;
        }
