...
public class JerotesNoMoveRangeAttackGoal extends Goal {
    ...
    public JerotesNoMoveRangeAttackGoal(RangedAttackMob rangedAttackMob, double d, int n, float f) {
        this(rangedAttackMob, d, n, n, f);
    }

    public JerotesNoMoveRangeAttackGoal(RangedAttackMob rangedAttackMob, double d, int n, int n2, float f) {
