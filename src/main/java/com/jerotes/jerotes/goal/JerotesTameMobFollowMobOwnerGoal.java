...
public class JerotesTameMobFollowMobOwnerGoal extends Goal {
    ...
    public JerotesTameMobFollowMobOwnerGoal(TameMobEntity tameMob, double d) {
    ...
    public boolean canContinueToUse() {
        ...
        if (((TameMobEntity)tameMob).isTame()) {
            return false;
        }
