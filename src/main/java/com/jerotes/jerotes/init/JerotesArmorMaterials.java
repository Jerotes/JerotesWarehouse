...
public enum JerotesArmorMaterials implements ArmorMaterial {
	COPPER("copper", 11, Util.make(new EnumMap<>(ArmorItem.Type.class), (p_266652_) -> {
	...
	}), 15, JerotesSoundEvents.ARMOR_EQUIP_COPPER, 0.0F, 0.0F, () -> {
	...
	private JerotesArmorMaterials(String p_268171_, int p_268303_, EnumMap<ArmorItem.Type, Integer> p_267941_, int p_268086_, SoundEvent p_268145_, float p_268058_, float p_268180_, Supplier<Ingredient> p_268256_) {
		this.name = p_268171_;
